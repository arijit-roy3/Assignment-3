        ...
        while (true){
            ...
            switch (ch) {
                ...
                case 4:{
                    ...
                    lst = work.getAll();
                    for(Worker w: lst){
                        System.out.println("Worker Id: "+w.getWorker_id()+", First Name: "+w.getFirst_name()+", Last Name: "+w.getLast_name()+", Salary: "+w.getSalary()+", Joining Date: "+w.getJoining_date()+", Department: "+w.getDepartment());
                    }
                    break;
                }
                default:
